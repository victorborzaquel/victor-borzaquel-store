...
import com.ada.victorborzaquelstore.modules.client.ClientMapper;
...
import com.ada.victorborzaquelstore.repositories.ClientDslRepository;
...
public class ClientService {
  ...
  public ClientEntity findByUsername(String username) {
    return this.clientRepository.findByUserUsername(username).orElseThrow(EmployeeNotFoundException::new);
  }
